    ...
    <div class="container">
        <div class="row footer-row">
            <div class="span3 footer-col">
                <h5>About Us</h5>
                <img src="<?php echo Yii::$app->homeUrl; ?>picolo/img/piccolo-footer-logo.png" alt="Piccolo" /><br /><br />
                <address>
            ...
            <div class="span3 footer-col">
                <h5>Flickr Photos</h5>
                <ul class="img-feed">
                    <li><a href="#"><img src="<?php echo Yii::$app->homeUrl; ?>picolo/img/gallery/flickr-img-1.jpg" alt="Image Feed"></a></li>
                    <li><a href="#"><img src="<?php echo Yii::$app->homeUrl; ?>picolo/img/gallery/flickr-img-1.jpg" alt="Image Feed"></a></li>
                    <li><a href="#"><img src="<?php echo Yii::$app->homeUrl; ?>picolo/img/gallery/flickr-img-1.jpg" alt="Image Feed"></a></li>
                    <li><a href="#"><img src="<?php echo Yii::$app->homeUrl; ?>picolo/img/gallery/flickr-img-1.jpg" alt="Image Feed"></a></li>
                    <li><a href="#"><img src="<?php echo Yii::$app->homeUrl; ?>picolo/img/gallery/flickr-img-1.jpg" alt="Image Feed"></a></li>
